    ...
    def forward_listener(
        ...
        **active** (Stage 3 – empathic backchannel):
        ...
        Returns:
            ...
            f_pose:         (B, style_dim) pose feature from bank (before motion projection).
            f_exp:          (B, style_dim) expression feature from bank (before motion projection).
            alpha_D_pose:   (B, pose_dim) pose motion coefficients.
            alpha_D_exp:    (B, exp_dim)  expression motion coefficients.
        ...
        if mode == 'passive':
            ...
            # Stage 3: stochastic pose/exp/audio from VAE; lip driven by TTS audio.
            ...
            f_pose, f_exp, audio_mel, mu_p, logvar_p, mu_e, logvar_e, mu_a, logvar_a = \
